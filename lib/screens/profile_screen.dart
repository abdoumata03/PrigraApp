                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      Padding(
                        padding:
                            EdgeInsets.symmetric(horizontal: getHeight(10)),
                ...
                Container(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                          'Nom: ${AuthController.instance.myDatareponsetype?['first_name']}',
                          style: TextStyle(
                        ...
                        Text(
                          'Prenom: ${AuthController.instance.myDatareponsetype?['last_name']}',
                          style: TextStyle(
                              fontSize: getHeight(20),
                              fontWeight: FontWeight.w500),
                        ),
                        ...
                        Text(
                          'Date de naissance: ${AuthController.instance.myDatareponsetype?['birth_date']}',
                          style: TextStyle(
                              fontSize: getHeight(20),
                              fontWeight: FontWeight.w500),
                        ),
                        ...
                        Text(
                          'Matricule: ${AuthController.instance.myDatareponsetype?['num_inscription']}',
                          style: TextStyle(
                              fontSize: getHeight(20),
                              fontWeight: FontWeight.w500),
                        ),
                        ...
                        Text(
                          'Numéro de téléphone: ${AuthController.instance.myDatareponsetype?['phone_number']}',
                          style: TextStyle(
                              fontSize: getHeight(20),
                              fontWeight: FontWeight.w500),
                        ),
                  ...
                  child: Container(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            'Vous etes: ${AuthController.instance.meType}',
                            style: TextStyle(
                                fontSize: getHeight(20),
                                fontWeight: FontWeight.w500),
                          ),
                          ...
                          Text(
                            'Etablissment: ${AuthController.instance.myDatareponsetype?['etablissment']}',
                            style: TextStyle(
                                fontSize: getHeight(20),
                                fontWeight: FontWeight.w500),
                          ),
                          ...
                          Text(
                            "Numéro d'inscription : ${AuthController.instance.myDatareponsetype?['num_inscription']}",
                            style: TextStyle(
                                fontSize: getHeight(20),
                                fontWeight: FontWeight.w500),
                          ),
                          ...
                          Text(
                            'Filière: ${AuthController.instance.myDatareponsetype?['filière']}',
                            style: TextStyle(
                                fontSize: getHeight(20),
                                fontWeight: FontWeight.w500),
                          ),
                          ...
                          Text(
                            'Spécialité: ${AuthController.instance.myDatareponsetype?['spécialité']}',
                            style: TextStyle(
                                fontSize: getHeight(20),
                                fontWeight: FontWeight.w500),
                          ),
